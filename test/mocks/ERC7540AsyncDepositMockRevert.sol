...
contract ERC7540AsyncDepositRevertMock is IERC7540Deposit, IERC7540Operator, IAuthorizeOperator, IERC7575 {
    ...
    function supportsInterface(bytes4 interfaceId) external pure override returns (bool) {
        return interfaceId == type(IERC7540Deposit).interfaceId || interfaceId == type(IERC7540Operator).interfaceId
    ...
    /// @inheritdoc IERC7540Deposit
    function deposit(uint256, address, address) public pure returns (uint256) {
        revert();
    }

    function deposit(uint256, address, address, uint256) public pure returns (uint256) {
        revert();
    }
