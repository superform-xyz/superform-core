        ...
        if (args.underlyingTokenDst != args.underlyingToken) {
            ...
            /// @dev decimal1 = decimals of args.underlyingTokenDst (src chain), decimal2 = decimals of args.underlyingToken
            /// (src chain)
        ...
        /// @dev v.decimal3 = decimals of args.underlyingToken (args.underlyingTokenDst too if above holds true) (src chain),
        ...
        if (v.decimal3 > v.decimal2) {
            v.amount = (args.amount * uint256(USDPerUnderlyingToken))
                / (uint256(USDPerExternalToken) * 10 ** (v.decimal3 - v.decimal2));
        } else {
