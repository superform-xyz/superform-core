...
//         SuperformFactory(getContract(chainId, "SuperformFactory")).addFormBeacon(formImplementation, formBeaconId,
// salt);

//         uint256 totalSuperformsBefore = SuperformFactory(getContract(chainId,
// "SuperformFactory")).getSuperformCount();
...
//         uint256 totalSuperformsAfter = SuperformFactory(getContract(chainId,
// "SuperformFactory")).getSuperformCount();
