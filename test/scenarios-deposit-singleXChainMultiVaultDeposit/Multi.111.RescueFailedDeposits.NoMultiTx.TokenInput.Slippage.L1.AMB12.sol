...
contract SDMVDMulti111RescueFailedDepositsNoMultiTxTokenInputSlippageL1AMB12 is ProtocolActions {
        ...
        public
    {
        ...
        uint256 dstAmountOne = (AMOUNTS[AVAX][0][0] * uint256(10_000 - actions[0].slippage)) / 10_000;
        uint256 dstAmountTwo = (AMOUNTS[AVAX][0][1] * uint256(10_000 - actions[0].slippage)) / 10_000;
        uint256 dstAmountThree = (AMOUNTS[AVAX][0][2] * uint256(10_000 - actions[0].slippage)) / 10_000;
