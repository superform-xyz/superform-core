...
contract SXMVW7540ADepositAWithdraw5115SlippageDstSwapAMB13 is ProtocolActions {
    function setUp() public override {
        ...
        TARGET_UNDERLYINGS[OP][0] = [0, 4, 2];

        TARGET_VAULTS[OP][0] = [11, 9, 12];

        TARGET_FORM_KINDS[OP][0] = [4, 3, 4];

        TARGET_UNDERLYINGS[OP][1] = [0, 4, 2];

        TARGET_VAULTS[OP][1] = [11, 9, 12];

        TARGET_FORM_KINDS[OP][1] = [4, 3, 4];
    ...
    function test_scenario(uint128 amountOne_) public {
        ...
        AMOUNTS[OP][0] = [amountOne_, amountOne_, amountOne_];
        ...
        for (uint256 act = 0; act < actions.length; ++act) {
            ...
            if (act == 1) {
                ...
                AMOUNTS[OP][1] = [superPositions[0], superPositions[1], superPositions[2]];
            }
