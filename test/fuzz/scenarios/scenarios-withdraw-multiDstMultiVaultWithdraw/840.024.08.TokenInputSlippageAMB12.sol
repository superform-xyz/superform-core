...
contract MDMVW84002408NativeInputSlipageAMB12ABA is ProtocolActions {
        ...
        public
    {
        ...
        amountOne_ = uint128(bound(amountOne_, 2e18, TOTAL_SUPPLY_ETH / 8));
        amountTwo_ = uint128(bound(amountTwo_, 2e18, TOTAL_SUPPLY_ETH / 8));
        amountThree_ = uint128(bound(amountThree_, 2e18, TOTAL_SUPPLY_ETH / 8));
