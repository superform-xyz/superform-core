...
contract MDMVW5115TokenInputSlipageAMB23 is ProtocolActions {
    function setUp() public override {
        chainIds = [ETH, OP, AVAX];
    ...
    //////////////////////////////////////////////////////////////*/
        ...
        AMOUNTS[OP][0] = [9765, 9765, 222];
        AMOUNTS[OP][1] = [9765, 9765, 2];

        PARTIAL[OP][1] = [false, false, true];
        ...
        LIQ_BRIDGES[OP][0] = [1, 1, 1, 1];
        LIQ_BRIDGES[OP][1] = [1, 1, 1, 1];
        ...
        FINAL_LIQ_DST_WITHDRAW[OP] = [ETH, ETH, ETH, ETH];
        ...
        public
    {
        ...
        AMOUNTS[OP][0] = [amountTwo_, amountThree_, amountOne_];
