...
contract MDMVW84002408NativeInputSlipageAMB12NewDst is ProtocolActions {
        ...
        public
    {
        ...
        amountOne_ = uint128(bound(amountOne_, 12 * 10 ** 18, TOTAL_SUPPLY_ETH / 8));
        amountTwo_ = uint128(bound(amountTwo_, 11 * 10 ** 18, TOTAL_SUPPLY_ETH / 8));
        amountThree_ = uint128(bound(amountThree_, 11 * 10 ** 18, TOTAL_SUPPLY_ETH / 8));
