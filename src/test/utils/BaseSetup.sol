...
abstract contract BaseSetup is DSTest, Test {
    ...
    function _deployProtocol() internal {
        ...
        for (uint256 i = 0; i < chainIds.length; i++) {
            ...
            /// @dev 4.1.1- deploy Payload Helper
            vars.PayloadHelper = address(new PayloadHelper{salt: salt}(vars.coreStateRegistry));
            contracts[vars.chainId][bytes32(bytes("PayloadHelper"))] = vars.PayloadHelper;

            /// @dev 4.1.2- deploy Fee Helper
    ...
    function estimateMsgValue(
        ...
        for (uint256 i; i < dstChainIds.length; i++) {
            address _FeeHelper = contracts[dstChainIds[i]][bytes32(bytes("FeeHelper"))];
            FeeHelper feeHelper = FeeHelper(_FeeHelper);

            /// FIXME: replace the message with the original message
            bytes
                memory message = hex"";

            (uint256 fees, ) = feeHelper.estimateFees(selectedAmbIds, dstChainIds[i], message, adapterParams);
            console.log(fees);
            totalFees += fees;
        }
    }
    ...
    function generateExtraData(uint8[] memory selectedAmbIds) internal pure returns (bytes[] memory) {
    ...
    function generateCoreStateRegistryParams(
        uint64[] memory dstChainIds,
        uint8[] memory selectedAmbIds
        ...
        for (uint256 i; i < dstCount; i++) {
            ...
            (totalFees, gasPerAMB) = feeHelper.estimateFees(selectedAmbIds, dstChainIds[i], message, paramsPerAMB);

            AMBExtraData memory extraData = AMBExtraData(gasPerAMB, paramsPerAMB);

            paramsPerDST[i] = abi.encode(SingleDstAMBParams(totalFees, abi.encode(extraData)));
        }
    ...
    function generateAckGasFeesAndParams(
        uint64 dstChainId,
        uint8[] memory selectedAmbIds
        ...
        return (totalFees, abi.encode(AckAMBData(selectedAmbIds, abi.encode(extraData))));
    }
}
