...
struct LiqRequest {
    ...
    address token; /// @dev this is the input token (pre-swap, not necessarily the underlying token)
    uint256 amount; /// @dev in what amount token is bridged (already present inside txData
