    ...
    LiquidityHandler
{
    ...
    function updateSafeGasParam(bytes memory param_)
        external
        override
    ...
    function previewDepositTo(uint256 vaultId_, uint256 assets_)
        public
        view
        override
        returns (uint256)
    ...
    function previewWithdrawFrom(uint256 vaultId_, uint256 assets_)
        public
        view
        override
        returns (uint256)
    ...
    function positionBalance(uint256 positionId_)
        public
        view
        override
    ...
    function addValues(uint256[] memory amounts_)
        internal
        pure
        returns (uint256)
    {
