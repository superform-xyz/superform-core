...
interface IDstSwapper {
    ...
    /// @notice updates dst swap failure for core state registry
    /// @param payloadId_ represents the id of the payload
    ...
    /// @notice updates dst swap failure for core state registry in batch
    /// @param payloadId_ represents the id of the payload
    ...
    /// @notice is a previlaged function that allows Core State Registry to process refunds
