...
interface IDstSwapper {
    ...
    /// @notice updates the amounts of intermediary tokens stuck for failing dst swap
    /// @param payloadId_ represents the id of the payload
    ...
    /// @notice updates the amounts of intermediary tokens stuck for failing dst swap in batch
    /// @param payloadId_ represents the id of the payload
