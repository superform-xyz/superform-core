...
Addresses obtained with a sample deployment to Polygon
{
    ...
    "LiFiValidator": "0xA96ced02619a4648884c3e897eD4280cd7Dfe15D", - due to surl >Diff
    "PayMaster": "0x4E3Bcd5B7571aAf8e000D9641df8c16d70B1a4b0", - due to surl >Diff
    "PayloadHelper": "0x5Ae08549F266a9B4cC95Ad8aac57bE6Af236b647",
    "PaymentHelper": "0xe14BCe82D4a72e4C95402a83fEF3C2299a61fD8C", - due to surl + IpaymentHelper >Diff
    "RewardsDistributor": "0xb779de9C79AC9B1d9B90cc61b593C5aE4aad51D3", - due to surl >Diff
...
FOUNDRY_PROFILE=production forge script script/forge-scripts/misc/Mainnet.Deploy.NewChain.s.sol:MainnetDeployNewChain --sig "deployStage1(uint256,uint256,uint256)" 1 0 0 --rpc-url $BLAST_RPC_URL --slow --account default --sender 0x48aB8AdF869Ba9902Ad483FB1Ca2eFDAb6eabe92

wait

echo Running Stage 2: ...

FOUNDRY_PROFILE=production forge script script/forge-scripts/misc/Mainnet.Deploy.NewChain.s.sol:MainnetDeployNewChain --sig "deployStage2(uint256,uint256,uint256)" 1 0 0 --rpc-url $BLAST_RPC_URL --slow --account default --sender 0x48aB8AdF869Ba9902Ad483FB1Ca2eFDAb6eabe92

wait

echo Running Stage 3: ...

FOUNDRY_PROFILE=production forge script script/forge-scripts/misc/Mainnet.Deploy.NewChain.s.sol:MainnetDeployNewChain --sig "deployStage3(uint256,uint256,uint256)" 1 0 0 --rpc-url $BLAST_RPC_URL --slow --account default --sender 0x48aB8AdF869Ba9902Ad483FB1Ca2eFDAb6eabe92
...
FOUNDRY_PROFILE=production forge script script/forge-scripts/misc/Mainnet.Deploy.NewChain.s.sol:MainnetDeployNewChain --sig "revokeBurnerAddress(uint256,uint256)" 1 0 --rpc-url $LINEA_RPC_URL --slow --account default --sender 0x48aB8AdF869Ba9902Ad483FB1Ca2eFDAb6eabe92 --legacy
